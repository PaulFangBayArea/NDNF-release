                                     ...
                                     pit::Entry& pitEntry)
{
  NFD_LOG_DEBUG("afterReceiveLoopedInterest pitEntry=" << pitEntry.getName()
                << " in=" << ingress);
 //std::cout<< "afterReceiveLoopedInterest pitEntry=" << pitEntry.getName()<< " in=" << ingress<<std::endl;
}
                                ...
                                const FaceEndpoint& ingress, const Data& data)
{
  ...
  //std::cout<< "beforeSatisfyInterest pitEntry=" << pitEntry->getName()<< " in=" << ingress << " data=" << data.getName()<<std::endl;               
}
                               ...
                               const FaceEndpoint& ingress, const Data& data)
{
  NFD_LOG_DEBUG("afterContentStoreHit pitEntry=" << pitEntry->getName()
                << " in=" << ingress << " data=" << data.getName());
  //std::cout<<"afterContentStoreHit pitEntry=" << pitEntry->getName() << " in=" << ingress << " data=" << data.getName()<<std::endl; 
                           ...
                           const FaceEndpoint& ingress, const Data& data)
{
  NFD_LOG_DEBUG("afterReceiveData pitEntry=" << pitEntry->getName()
                << " in=" << ingress << " data=" << data.getName());
//std::cout<<"afterReceiveData pitEntry=" << pitEntry->getName()<< " in=" << ingress << " data=" << data.getName()<<std::endl; 
                           ...
                           const shared_ptr<pit::Entry>& pitEntry)
{
  ...
  //std::cout<<"afterReceiveNack in=" << ingress << " pitEntry=" << pitEntry->getName()<<std::endl; 
}
...
Strategy::onDroppedInterest(const FaceEndpoint& egress, const Interest& interest)
{
  ...
  //std::cout<<"onDroppedInterest out=" << egress << " name=" << interest.getName()<<std::endl; 
}
...
Strategy::afterNewNextHop(const fib::NextHop& nextHop, const shared_ptr<pit::Entry>& pitEntry)
{
  ...
  //std::cout<<"afterNewNextHop pitEntry=" << pitEntry->getName()<< " nexthop=" << nextHop.getFace().getId()<<std::endl; 
}
