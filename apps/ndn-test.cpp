...
main(int argc, char* argv[])
{
  ...
  ndn::AppHelper app2("NFVC");
  //app2.SetAttribute("PayloadSize", StringValue("1024"));
  app2.SetPrefix("/f/name");
  app2.SetAttribute("Frequency", StringValue("1"));
  app2.Install(nodes.Get(2));

  ndn::AppHelper producerHelper("ns3::ndn::Producer");
  producerHelper.SetPrefix("/name");
  producerHelper.SetAttribute("PayloadSize", StringValue("1024"));
  producerHelper.Install(nodes.Get(3)); // Producer
  ...
  ndn::FibHelper::AddRoute(Node0, "/f/name", Node1, 1); // link to n1
  ndn::FibHelper::AddRoute(Node1, "/f/name", Node2, 1); // link to n1
  ndn::FibHelper::AddRoute(Node1, "/f/name", Node3, 1); // link to n1
