 ...
 *                           |               |               |  
 *                           |               |               |  
 *      consumer<----> router # 0<----> router # 1<---->  router # 2 <----->  producer 
 *     
 * Node 0: consumer
 * Node 1: router #0
 * Node 2: NFV node #0
 ...
 *
 *     NS_LOG=ndn.Consumer:ndn.Producer ./waf --run=ndn-test-multinfv
 */
 class PcapWriter {
public:
...
main(int argc, char* argv[])
{
  ...
  PcapWriter trace("ndn-test-multinfv.pcap");
  ...
  //obtain metrics
  ndn::L3RateTracer::InstallAll("ndn-test-multinfv-L3-trace.txt", Seconds(1));

  ndn::CsTracer::InstallAll("ndn-test-multinfv-Cs-trace.txt", Seconds(1));
 
  ndn::AppDelayTracer::InstallAll("ndn-test-multinfv-app-delays-trace.txt");
