 ...
 * Node 0: consumer
 * Node 1: router #0
 * Node 2: NFV node #0 - f1
 * Node 3: router #1
 * Node 4: NFV node #1 - f3
 * Node 5: router #2
 * Node 6: NFV node #2 - f2
 * Node 7: producer
 * 
...
main(int argc, char* argv[])
{
  ...
  ndn::StrategyChoiceHelper::InstallAll("/f2/f3/name", "/localhost/nfd/strategy/multicast");
  ndn::StrategyChoiceHelper::InstallAll("/f3/name", "/localhost/nfd/strategy/multicast");
  ...
  consumerHelper.SetPrefix("/f1/f2/f3/name");
  consumerHelper.SetAttribute("Frequency", StringValue("1")); // 10 interests a second
  consumerHelper.Install(nodes.Get(0));                        // first node  
 
  // Node 2: NFV node 0
  ndn::AppHelper app1("ns3::ndn::NFVNode1");
  app1.SetAttribute("Prefix1", StringValue("/f1"));
  app1.SetAttribute("Prefix2", StringValue("/f1/f2/f3"));
  app1.SetAttribute("Signature", UintegerValue(2));
  app1.Install(nodes.Get(2));

  // Node 4: NFV node 1
  ndn::AppHelper app3("ns3::ndn::NFVNode3");
  ...
  // Node 6: NFV node 2
  ndn::AppHelper app2("ns3::ndn::NFVNode2");
  app2.SetAttribute("Prefix1", StringValue("/f2"));
  app2.SetAttribute("Prefix2", StringValue("/f2/f3"));
