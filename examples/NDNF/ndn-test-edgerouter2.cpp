...
main(int argc, char* argv[])
{
  ...
  //ndn::StrategyChoiceHelper::InstallAll("/f", "/localhost/nfd/strategy/multicast");
  ndn::StrategyChoiceHelper::InstallAll("/name0", "/localhost/nfd/strategy/multicast");
  //ndn::StrategyChoiceHelper::InstallAll("/edge", "/localhost/nfd/strategy/multicast");
  ...
  app3.SetAttribute("Prefix2", StringValue("/name0"));
  app3.SetAttribute("Signature", UintegerValue(5));
  app3.Install(nodes.Get(5));
  ...
  ndn::FibHelper::AddRoute(Node4, "/f", Node2, 1);  
  ...
  PcapWriter trace("ndn-test-edgerouter2.pcap");
  ...
  ndn::L3RateTracer::InstallAll("ndn-test-edgerouter2-L3-trace.txt", Seconds(1));

  ndn::CsTracer::InstallAll("ndn-test-edgerouter2-Cs-trace.txt", Seconds(1));

  printPitFib(nodes);

 
  ndn::AppDelayTracer::InstallAll("ndn-test-edgerouter2-app-delays-trace.txt");
